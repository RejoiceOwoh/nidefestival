...
export default function CTA() {
  ...
  const recipes = [
    ...
    { name: 'Abacha', image: 'https://res.cloudinary.com/dkjnkg7hd/image/upload/v1729717678/SAVE_20241023_213312_pfseiv.jpg' },
    { name: 'And Lots More', image: 'https://res.cloudinary.com/dkjnkg7hd/image/upload/v1729717677/SAVE_20241023_213320_ngsloi.jpg' },
  ]
